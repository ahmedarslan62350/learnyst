...
export const metadata: Metadata = {
  title:
    "BISE Karachi - Board of Intermediate Education Karachi | Results & Information",
  description:
  ...
  openGraph: {
    ...
    description:
      "Complete information about BISE Karachi including result checking and examination details.",
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-4xl leading-relaxed">
              The premier educational board of Sindh province, BISE Karachi has
              been serving the metropolitan city of Karachi since 1972,
              conducting examinations for over 400,000 students annually and
              maintaining the highest educational standards in the region.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-r from-green-50 to-blue-50">
                ...
                <CardContent>
                  <p className="text-slate-700 mb-6">
                    Enter your roll number to instantly check your BISE Karachi
                    examination results.
                  </p>
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4">
                  <p className="text-slate-700 leading-relaxed">
                    The Board of Intermediate Education, Karachi (BISE Karachi)
                    was established in 1972 and serves as the premier
                    educational authority for Karachi, Pakistan's largest city
                    and economic hub. The board conducts examinations for Higher
                    Secondary School Certificate (HSSC) level.
                  </p>
                  <p className="text-slate-700 leading-relaxed">
                    BISE Karachi is known for its rigorous academic standards
                    and comprehensive examination system. It serves the diverse
                    educational needs of Karachi's multicultural population and
                    has played a vital role in producing skilled professionals
                    for Pakistan's economy.
                  </p>
                  <p className="text-slate-700 leading-relaxed">
                    The board continuously adapts to modern educational
                    requirements while maintaining its commitment to academic
                    excellence and fair assessment practices across all its
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent>
                  <p className="text-slate-700 mb-6">
                    BISE Karachi serves the following areas in Karachi:
                  </p>
                    ...
                    {[
                      {
                        ...
                        description:
                          "Central business and educational district",
                      },
                      {
                        name: "Karachi East",
                        description: "Major residential and commercial areas",
                      },
                      {
                        name: "Karachi West",
                        description: "Industrial and port areas",
                      },
                      {
                        name: "Karachi South",
                        description: "Historic and administrative center",
                      },
                    ].map((area, index) => (
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                        <li>
                          Multilingual examination support (Urdu, English,
                          Sindhi)
                        </li>
                        <li>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-600">
                        Board Office, Karachi, Sindh, Pakistan
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
