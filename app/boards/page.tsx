...
import { GraduationCap, ArrowLeft, MapPin, Users, BookOpen, ExternalLink } from "lucide-react"
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Complete guide to all major educational boards in Pakistan with result checking information.",
...
const boards = [
  ...
  },
  {
    ...
    districts: ["Karachi Central", "Karachi East", "Karachi West", "Karachi South"],
    website: "biek.edu.pk",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    established: "1971",
    students: "280,000+",
    description: "One of the major boards in Punjab, serving the industrial city of Faisalabad.",
  ...
  },
  {
    ...
    established: "1976",
    students: "220,000+",
    description: "Serving the northern Punjab districts with comprehensive educational services.",
    districts: ["Gujranwala", "Gujrat", "Mandi Bahauddin", "Sialkot", "Narowal"],
    website: "bisegrw.com",
    featured: false,
  },
  {
  ...
  },
  {
    ...
    established: "1972",
    students: "200,000+",
    description: "Serving the interior Sindh region with quality educational services.",
  ...
  },
  {
    ...
    established: "1978",
    students: "150,000+",
    description: "Serving the northern Sindh region including Sukkur and surrounding areas.",
  ...
  },
  {
    ...
    established: "1968",
    students: "200,000+",
    description: "Serving the Sargodha division with comprehensive educational services.",
  ...
  },
  {
    ...
    districts: ["Bannu", "Lakki Marwat", "North Waziristan", "South Waziristan"],
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Complete guide to all major educational boards in Pakistan",
            url: "https://learnyst.pk/boards",
            mainEntity: {
              "@type": "ItemList",
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">Educational Boards in Pakistan</h1>
            <div className="w-32 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto rounded-full mb-6"></div>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive guide to all major educational boards across Pakistan. Find information about board
              services, districts covered, and result checking procedures.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {featuredBoards.map((board) => (
                ...
                >
                  ...
                  <CardContent>
                    <p className="text-slate-700 leading-relaxed mb-4">{board.description}</p>
                ...
                >
                  <CardHeader>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs text-slate-500">Est. {board.established}</span>
                    </div>
                  ...
                  <CardContent>
                    <p className="text-slate-600 text-sm leading-relaxed mb-4 line-clamp-3">{board.description}</p>
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-start space-x-2 text-xs text-slate-500">
                        ...
                        <span className="line-clamp-2">{board.districts.join(", ")}</span>
                      </div>
                    </div>
          ...
          <Card className="mt-12 shadow-lg border-0 bg-gradient-to-r from-slate-800 to-slate-900 text-white">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4">Check Your Result Now</h3>
              <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
                Ready to check your board exam results? Enter your roll number and get instant access to your academic
                performance.
              </p>
              <Link href="/">
