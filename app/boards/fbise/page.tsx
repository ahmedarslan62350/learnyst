...
export const metadata: Metadata = {
  title: "FBISE - Federal Board of Intermediate and Secondary Education | Results & Information",
  description:
  ...
  openGraph: {
    ...
    description: "Complete information about FBISE including result checking and examination details.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            alternateName: "FBISE",
            description: "The federal board serving federal government institutions and Pakistani schools abroad.",
            url: "https://learnyst.pk/boards/fbise",
            foundingDate: "1975",
            address: {
              "@type": "PostalAddress",
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-4xl leading-relaxed">
              The Federal Board of Intermediate and Secondary Education (FBISE) was established in 1975 to serve federal
              government institutions and Pakistani schools abroad. It conducts examinations for over 200,000 students
              annually and maintains the highest educational standards nationwide.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-r from-red-50 to-orange-50">
                ...
                <CardContent>
                  <p className="text-slate-700 mb-6">
                    Enter your roll number to instantly check your Federal Board examination results.
                  </p>
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="text-2xl font-bold text-slate-800">About FBISE</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-slate-700 leading-relaxed">
                    The Federal Board of Intermediate and Secondary Education (FBISE) was established in 1975 under the
                    Ministry of Federal Education and Professional Training, Government of Pakistan. It serves as the
                    premier federal educational authority conducting examinations for SSC and HSSC levels.
                  </p>
                  <p className="text-slate-700 leading-relaxed">
                    FBISE has a unique mandate to serve federal government institutions, cantonment areas, and Pakistani
                    schools abroad. The board is known for its rigorous academic standards, innovative examination
                    practices, and commitment to educational excellence at the national level.
                  </p>
                  <p className="text-slate-700 leading-relaxed">
                    With its headquarters in Islamabad, FBISE continues to set benchmarks in educational assessment and
                    plays a crucial role in maintaining uniform educational standards across federal institutions
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent>
                  <p className="text-slate-700 mb-6">FBISE serves the following areas and institutions:</p>
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      { name: "Islamabad", description: "Federal capital territory" },
                      { name: "Federal Areas", description: "FATA and federal administered areas" },
                      { name: "Cantonment Areas", description: "Military cantonment schools nationwide" },
                      { name: "International Schools", description: "Pakistani schools abroad" },
                      { name: "Federal Institutions", description: "Federal government schools and colleges" },
                      { name: "Diplomatic Missions", description: "Pakistani embassy schools worldwide" },
                    ].map((area, index) => (
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                        ...
                        <li>Standardized curriculum across all affiliated institutions</li>
                        <li>Digital examination and result management system</li>
                        <li>Special arrangements for overseas Pakistani students</li>
                        <li>Coordination with international educational bodies</li>
                      </ul>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-semibold text-slate-800">Institutions</div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-semibold text-slate-800">Countries</div>
                      <div className="text-sm text-slate-600">50+ Countries</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-600">H-8/4, Islamabad, Pakistan</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-600">+92-51-9260515</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-600">info@fbise.edu.pk</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Globe className="h-5 w-5 text-green-600" />
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-r from-slate-50 to-slate-100">
                ...
                <CardContent className="space-y-3">
                  ...
                  <Link
                    ...
                    className="block p-3 bg-white rounded-lg hover:bg-red-50 transition-colors"
                  >
                    <div className="font-semibold text-slate-800">BISE Karachi</div>
