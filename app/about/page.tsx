          ...
          <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Pakistan's fast and reliable online platform for checking
                educational board results
              </p>
            </div>
            ...
            <Card className="mb-8 shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                <p className="text-lg text-slate-700 leading-relaxed mb-6">
                  Welcome to{" "}
                  <strong className="text-blue-600">Learnyst.pk</strong>,
                  Pakistan's fast and reliable online platform for checking
                  educational board results. We understand the importance of
                  academic results for students and parents, and our mission is
                  to make result checking quick, simple, and accessible for
                  everyone.
                </p>
                <p className="text-lg text-slate-700 leading-relaxed">
                  With Learnyst.pk, you can easily check results for{" "}
                  <strong>9th, 10th, 11th, and 12th classes</strong> from all
                  major boards of Pakistan in just a few clicks – anytime,
                  anywhere.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="mb-8 shadow-lg border-0 bg-gradient-to-r from-blue-50 to-purple-50">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-slate-700 leading-relaxed">
                  Our goal is to become Pakistan's most trusted result-checking
                  website, ensuring that students never face delays or
                  difficulties in accessing their academic records.
                </p>
              </CardContent>
            </Card>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">
                          Instantly find your results by entering your roll
                          number.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">
                          Access results for all major educational boards across
                          Pakistan.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">
                          Check your results easily from your smartphone or
                          tablet.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">
                          We provide verified and authentic result data from
                          official sources.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">
                          No hidden fees or charges – just simple result
                          checking.
                        </p>
                      </div>
                    </div>
            ...
            <Card className="mb-8 shadow-lg border-0 bg-gradient-to-r from-green-50 to-blue-50">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-slate-700 leading-relaxed">
                  To help students and parents across Pakistan get quick,
                  accurate, and hassle-free access to their academic results,
                  reducing the need to wait in long queues or visit board
                  offices.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-slate-700 leading-relaxed mb-6">
                  For support, suggestions, or inquiries, feel free to reach
                  out:
                </p>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-slate-700">
                      Website: www.learnyst.pk
                    </span>
                  </div>
                </div>
                <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                  <p className="text-slate-700 leading-relaxed italic">
                    We're here to make result checking simple and stress-free,
                    so you can focus on what truly matters – your education and
                    future success.
                  </p>
                </div>
              </CardContent>
