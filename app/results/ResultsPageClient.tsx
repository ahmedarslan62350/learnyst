    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mb-2">Fetching Your Results</h2>
          <p className="text-slate-600">Please wait while we retrieve your marks...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-slate-600 mb-6">
            No results found for roll number "{rollNumber}". Please check your roll number and try again.
          </p>
          <Link href="/">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">{result.studentName}</h1>
              ...
              <div className="mb-8">
                ...
                <span className="text-lg font-semibold text-slate-800">{result.rollNumber}</span>
              </div>
            </div>
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-12 text-center">
                <div className="text-7xl md:text-8xl font-bold text-slate-800 mb-4">{result.percentage}%</div>
            ...
            <div className="text-center">
              <p className="text-slate-500 text-sm leading-relaxed max-w-2xl mx-auto">
                This data is extracted from the public gazette and is not affiliated with any board.
              </p>
            </div>
          </div>
