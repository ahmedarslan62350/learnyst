...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Read study tips, exam preparation guides, and educational updates for Pakistani students.",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Educational blog with study tips, exam guides, and academic advice for Pakistani students",
              url: "https://learnyst.pk/blog",
              publisher: {
                "@type": "Organization",
                name: "Learnyst.pk",
          ...
          <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Study tips, exam guides, and educational insights to help you
            ...
            <Card className="mt-16 shadow-lg border-0 bg-gradient-to-r from-blue-50 to-purple-50">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
                  Get the latest study tips, exam guides, and educational
                  insights delivered to your inbox. Join thousands of students
