...
export const metadata: Metadata = {
  ...
  keywords: ["sitemap", "website navigation", "site structure", "page directory", "website map"],
  openGraph: {
...
export default function SitemapPage() {
  const pages = [
    { name: "Home", href: "/", description: "Student result checking homepage" },
    { name: "About", href: "/about", description: "Learn about Learnyst.pk and our services" },
    { name: "Contact", href: "/contact", description: "Get in touch with our support team" },
    { name: "Policies", href: "/policies", description: "Legal policies and terms" },
    { name: "Privacy Policy", href: "/policies/privacy", description: "How we protect your privacy" },
    { name: "Terms & Conditions", href: "/policies/terms", description: "Terms of service and usage" },
    { name: "Results", href: "/results", description: "Student result display page" },
    { name: "Sitemap", href: "/sitemap", description: "Website navigation overview" },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">Sitemap</h1>
        ...
        <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-slate-800">All Pages</CardTitle>
          </CardHeader>
