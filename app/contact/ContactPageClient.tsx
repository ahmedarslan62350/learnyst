          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              ...
              <CardContent>
                ...
                <p className="font-semibold text-slate-800">+92-XXX-XXXXXXX</p>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">
                      Simply enter your roll number on our homepage and click
                      "Check Now" to view your results instantly.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-1">
                    ...
                    <p className="text-slate-600 text-sm">
                      We support all major educational boards across Pakistan
                      for classes 9th, 10th, 11th, and 12th.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-1">
                    ...
                    <p className="text-slate-600 text-sm">
                      Yes, our result checking service is completely free with
                      no hidden charges.
                    </p>
                  </div>
                </div>
