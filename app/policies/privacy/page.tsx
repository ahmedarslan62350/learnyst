            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                <p className="text-lg text-slate-700 leading-relaxed mb-4">
                  ...
                  website and use our student result checking services.
                </p>
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="p-8 pt-0">
                <p className="text-slate-700 leading-relaxed">
                  ...
                  enforce our agreements. Roll numbers used for result checking
                  are not stored permanently and are only used for the duration
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="p-8 pt-0">
                <p className="text-slate-700 leading-relaxed">
                  ...
                  13 without parental consent. If you are a parent or guardian
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="p-8 pt-0">
                <p className="text-slate-700 leading-relaxed">
                  ...
                  of our website after such changes constitutes acceptance of
                  the updated policy.
                </p>
              </CardContent>
            </Card>
