      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-slate-800">Privacy Policy</h1>
          </div>
        ...
        <div className="space-y-8">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardContent className="p-8">
              <p className="text-lg text-slate-700 leading-relaxed mb-4">
                At ResultCheck (Learnyst.pk), we are committed to protecting your privacy and ensuring the security of
                your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard
                your information when you visit our website and use our student result checking services.
              </p>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">1. Information We Collect</CardTitle>
            </CardHeader>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">2. How We Use Your Information</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">3. Cookies and Tracking Technologies</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-slate-800 mb-2">Types of Cookies We Use:</h3>
                  <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                    <li>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">4. Third-Party Services</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <div className="space-y-4">
                <p className="text-slate-700 leading-relaxed">
                  We may use third-party services to enhance our website functionality and provide better services:
                </p>
                <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                  <li>
                  ...
                  <li>
                    <strong>Google Analytics:</strong> For website traffic analysis and performance monitoring
                  </li>
                  <li>
                    <strong>Cloud Hosting Services:</strong> For website hosting and data storage
                  </li>
                </ul>
                <p className="text-slate-700 leading-relaxed">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">5. Data Security</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">6. Your Privacy Rights</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">7. Data Retention</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed">
                We retain your personal information only for as long as necessary to fulfill the purposes outlined in
                this privacy policy, comply with legal obligations, resolve disputes, and enforce our agreements. Roll
                numbers used for result checking are not stored permanently and are only used for the duration of the
                search session.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">8. Children's Privacy</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed">
                Our website is designed to serve students of all ages. We do not knowingly collect personal information
                from children under 13 without parental consent. If you are a parent or guardian and believe your child
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">9. Changes to This Privacy Policy</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed">
