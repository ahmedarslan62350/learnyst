...
import { GraduationCap, Shield, FileText, ArrowLeft, ExternalLink } from "lucide-react"
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Access ResultCheck's legal policies including privacy policy and terms & conditions.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">Legal Policies</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Learn how we collect, use, and protect your personal information when you use our result checking
                service.
              </p>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Understand the terms of service and conditions for using our student result checking platform.
              </p>
              <ul className="space-y-2 text-sm text-slate-600 mb-6">
        ...
        <Card className="mt-8 shadow-lg border-0 bg-gradient-to-r from-blue-50 to-purple-50">
          <CardContent className="p-8 text-center">
            <h3 className="text-xl font-bold text-slate-800 mb-4">Questions About Our Policies?</h3>
            <p className="text-slate-600 mb-6">
              If you have any questions about our privacy policy or terms of service, please don't hesitate to contact
              us.
            </p>
            <Link href="/contact">
