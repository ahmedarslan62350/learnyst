...
import { GraduationCap, ArrowLeft, FileText, Mail, Calendar, AlertTriangle } from "lucide-react"
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Read the terms and conditions for using ResultCheck's student result checking platform.",
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-slate-800">Terms & Conditions</h1>
          </div>
        ...
        <div className="space-y-8">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardContent className="p-8">
              <p className="text-lg text-slate-700 leading-relaxed mb-4">
                Welcome to ResultCheck (Learnyst.pk). These Terms and Conditions ("Terms") govern your use of our
                website and student result checking services. By accessing or using our website, you agree to be bound
                by these Terms.
              </p>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">1. Acceptance of Terms</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed mb-4">
                By accessing and using ResultCheck (Learnyst.pk), you accept and agree to be bound by the terms and
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">2. Description of Service</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed mb-4">
                ResultCheck provides an online platform for checking educational board results in Pakistan. Our services
                include:
              </p>
              <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">3. User Responsibilities</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed mb-4">As a user of our website, you agree to:</p>
              <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                <li>Provide accurate and truthful information</li>
                <li>Use the service only for legitimate result checking purposes</li>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed mb-4">You may not use our website for:</p>
              <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">5. Intellectual Property Rights</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <div className="space-y-4">
                <p className="text-slate-700 leading-relaxed">
                  The website and its original content, features, and functionality are and will remain the exclusive
                  property of ResultCheck (Learnyst.pk) and its licensors.
                </p>
                <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">6. Disclaimer</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <div className="space-y-4">
                <p className="text-slate-700 leading-relaxed">
                  <strong>IMPORTANT:</strong> The information on this website is provided on an "as is" basis. To the
                  fullest extent permitted by law, this Company:
                </p>
                <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                  <li>Excludes all representations and warranties relating to this website and its contents</li>
                  <li>Does not guarantee the accuracy of result information</li>
                  <li>Is not affiliated with any educational board or government institution</li>
                  <li>Results are extracted from public sources and may contain errors</li>
                  <li>Users should verify results with official board sources</li>
                </ul>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">7. Limitation of Liability</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed mb-4">
                In no event shall ResultCheck (Learnyst.pk), nor its directors, employees, partners, agents, suppliers,
              ...
              <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                ...
                <li>Damages resulting from unauthorized access, use, or alteration of your transmissions</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">8. Indemnification</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed">
                You agree to defend, indemnify, and hold harmless ResultCheck (Learnyst.pk) and its licensee and
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">9. Termination</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">10. Governing Law</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed">
                These Terms shall be interpreted and governed by the laws of Pakistan. Any disputes relating to these
                terms will be subject to the exclusive jurisdiction of the courts of Pakistan.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-800">11. Changes to Terms</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <p className="text-slate-700 leading-relaxed">
                We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a
                revision is material, we will try to provide at least 30 days notice prior to any new terms taking
                effect. Your continued use of the website after we post any modifications constitutes acceptance of the
                new Terms.
              </p>
            </CardContent>
          </Card>
