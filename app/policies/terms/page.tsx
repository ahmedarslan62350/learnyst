            ...
            <div className="space-y-8">
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="p-8 pt-0">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                    <li>
                      Online result checking for various educational boards
                    </li>
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="p-8 pt-0">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                    ...
                    <li>
                      Use the service only for legitimate result checking
                      purposes
                    </li>
                    <li>
                ...
                <CardContent className="p-8 pt-0">
                  <div className="space-y-4">
                    <p className="text-slate-700 leading-relaxed">
                      ...
                      of ResultCheck (Learnyst.pk) and its licensors.
                    </p>
                    <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                      <li>
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="p-8 pt-0">
                  <div className="space-y-4">
                    <p className="text-slate-700 leading-relaxed">
                      <strong>IMPORTANT:</strong> The information on this
                      website is provided on an "as is" basis. To the fullest
                    ...
                    <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                      ...
                      <li>
                        Is not affiliated with any educational board or
                        government institution
                      </li>
                      <li>
                        Results are extracted from public sources and may
                        contain errors
                      </li>
                      <li>
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="p-8 pt-0">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
                    ...
                    <li>
                      Damages resulting from your access to or use of our
                      services
                    </li>
                    <li>
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="p-8 pt-0">
                  <p className="text-slate-700 leading-relaxed">
                    ...
                    ResultCheck (Learnyst.pk) and its licensee and licensors,
                    and their employees, contractors, agents, officers and
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="p-8 pt-0">
                  <p className="text-slate-700 leading-relaxed">
                    ...
                    Pakistan. Any disputes relating to these terms will be
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="p-8 pt-0">
                  <p className="text-slate-700 leading-relaxed">
                    ...
                    new terms taking effect. Your continued use of the website
                    after we post any modifications constitutes acceptance of
                    the new Terms.
                  </p>
                </CardContent>
              </Card>
